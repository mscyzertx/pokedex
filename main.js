let images = ["images/Bulbasaur.png", "images/002Ivysaur.png" , "images/vwnusaur.png", "images/charmandar.png", "images/charmeleon.jpeg"]
...
async function renderPokemon() {
    ...
    pokemons.forEach(pokemon => {
        ...
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="${images[i]}" alt="" class="img-fluid rounded-circle mb-3">
          <div><button type="button" value="${pokemon.name}" class="btn btn-outline-info" onclick="showSpecs(this)">${pokemon.name}</></div>
